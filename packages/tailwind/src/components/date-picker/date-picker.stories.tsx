...
import { DatePicker } from './snippet'
              ...
              <>
                <DatePicker.ViewControl>
                  <DatePicker.PrevTrigger asChild>
                    <IconButton variant="ghost" size="sm" aria-label="previous">
                      <ChevronLeftIcon />
                    </IconButton>
                  ...
                  <DatePicker.NextTrigger asChild>
                    <IconButton variant="ghost" size="sm" aria-label="next">
                      <ChevronRightIcon />
                    </IconButton>
                        ...
                        {week.map((day, id) => (
                          <DatePicker.TableCell key={id} value={day}>
                            <DatePicker.TableCellTrigger asChild>
                              <IconButton variant="ghost" aria-label="day">
                                {day.day}
                              </IconButton>
