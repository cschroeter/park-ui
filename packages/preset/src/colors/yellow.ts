...
export const yellow = defineSemanticTokens.colors({
  ...
  solid: {
    bg: {
      ...
      active: { value: { _light: '{colors.yellow.11}', _dark: '{colors.yellow.11}' } },
    },
  ...
  surface: {
    ...
    fg: { DEFAULT: { value: { _light: '{colors.yellow.a11}', _dark: '{colors.yellow.a11}' } } },
    border: {
      DEFAULT: { value: { _light: '{colors.yellow.a5}', _dark: '{colors.yellow.a5}' } },
      hover: { value: { _light: '{colors.yellow.a6}', _dark: '{colors.yellow.a6}' } },
      active: { value: { _light: '{colors.yellow.a6}', _dark: '{colors.yellow.a6}' } },
    },
  },
  outline: {
    bg: {
    ...
    fg: { DEFAULT: { value: { _light: '{colors.yellow.a11}', _dark: '{colors.yellow.a11}' } } },
    border: {
      DEFAULT: { value: { _light: '{colors.yellow.a7}', _dark: '{colors.yellow.a7}' } },
      hover: { value: { _light: '{colors.yellow.a8}', _dark: '{colors.yellow.a8}' } },
      active: { value: { _light: '{colors.yellow.a8}', _dark: '{colors.yellow.a8}' } },
    },
  },
  plain: {
    bg: {
