...
export const plum = defineSemanticTokens.colors({
  ...
  solid: {
    bg: {
      ...
      active: { value: { _light: '{colors.plum.11}', _dark: '{colors.plum.11}' } },
    },
  ...
  surface: {
    ...
    fg: { DEFAULT: { value: { _light: '{colors.plum.a11}', _dark: '{colors.plum.a11}' } } },
    border: {
      DEFAULT: { value: { _light: '{colors.plum.a5}', _dark: '{colors.plum.a5}' } },
      hover: { value: { _light: '{colors.plum.a6}', _dark: '{colors.plum.a6}' } },
      active: { value: { _light: '{colors.plum.a6}', _dark: '{colors.plum.a6}' } },
    },
  },
  outline: {
    bg: {
    ...
    fg: { DEFAULT: { value: { _light: '{colors.plum.a11}', _dark: '{colors.plum.a11}' } } },
    border: {
      DEFAULT: { value: { _light: '{colors.plum.a7}', _dark: '{colors.plum.a7}' } },
      hover: { value: { _light: '{colors.plum.a8}', _dark: '{colors.plum.a8}' } },
      active: { value: { _light: '{colors.plum.a8}', _dark: '{colors.plum.a8}' } },
    },
  },
  plain: {
    bg: {
