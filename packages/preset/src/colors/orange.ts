...
export const orange = defineSemanticTokens.colors({
  ...
  solid: {
    bg: {
      ...
      active: { value: { _light: '{colors.orange.11}', _dark: '{colors.orange.11}' } },
    },
  ...
  surface: {
    ...
    fg: { DEFAULT: { value: { _light: '{colors.orange.a11}', _dark: '{colors.orange.a11}' } } },
    border: {
      DEFAULT: { value: { _light: '{colors.orange.a5}', _dark: '{colors.orange.a5}' } },
      hover: { value: { _light: '{colors.orange.a6}', _dark: '{colors.orange.a6}' } },
      active: { value: { _light: '{colors.orange.a6}', _dark: '{colors.orange.a6}' } },
    },
  },
  outline: {
    bg: {
    ...
    fg: { DEFAULT: { value: { _light: '{colors.orange.a11}', _dark: '{colors.orange.a11}' } } },
    border: {
      DEFAULT: { value: { _light: '{colors.orange.a7}', _dark: '{colors.orange.a7}' } },
      hover: { value: { _light: '{colors.orange.a8}', _dark: '{colors.orange.a8}' } },
      active: { value: { _light: '{colors.orange.a8}', _dark: '{colors.orange.a8}' } },
    },
  },
  plain: {
    bg: {
