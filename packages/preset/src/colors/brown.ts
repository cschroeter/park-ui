...
export const brown = defineSemanticTokens.colors({
  ...
  fg: { value: { _light: '{colors.brown.a11}', _dark: '{colors.brown.a11}' } },
  solid: { value: { _light: '{colors.brown.9}', _dark: '{colors.brown.9}' } },
  emphasiszed: { value: { _light: '{colors.brown.10}', _dark: '{colors.brown.10}' } },
})
