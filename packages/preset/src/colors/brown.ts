...
export const brown = defineSemanticTokens.colors({
  ...
  solid: {
    bg: {
      ...
      active: { value: { _light: '{colors.brown.11}', _dark: '{colors.brown.11}' } },
    },
  ...
  surface: {
    ...
    fg: { DEFAULT: { value: { _light: '{colors.brown.a11}', _dark: '{colors.brown.a11}' } } },
    border: {
      DEFAULT: { value: { _light: '{colors.brown.a5}', _dark: '{colors.brown.a5}' } },
      hover: { value: { _light: '{colors.brown.a6}', _dark: '{colors.brown.a6}' } },
      active: { value: { _light: '{colors.brown.a6}', _dark: '{colors.brown.a6}' } },
    },
  },
  outline: {
    bg: {
    ...
    fg: { DEFAULT: { value: { _light: '{colors.brown.a11}', _dark: '{colors.brown.a11}' } } },
    border: {
      DEFAULT: { value: { _light: '{colors.brown.a7}', _dark: '{colors.brown.a7}' } },
      hover: { value: { _light: '{colors.brown.a8}', _dark: '{colors.brown.a8}' } },
      active: { value: { _light: '{colors.brown.a8}', _dark: '{colors.brown.a8}' } },
    },
  },
  plain: {
    bg: {
