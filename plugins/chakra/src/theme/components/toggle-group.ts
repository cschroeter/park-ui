...
export const ToggleGroup = defineMultiStyleConfig({
  baseStyle: definePartsStyle((props) => ({
    ...
    item: {
      ...
      whiteSpace: 'nowrap',
      _hover: { color: 'fg.default', background: 'gray.a3' },
      _checked: { background: 'gray.a3', color: 'fg.default' },
      _pressed: { background: 'gray.a3', color: 'fg.default' },
      _disabled: {
  ...
  variants: {
    outline: definePartsStyle((props) => ({
      root: {
        ...
        _horizontal: { divideX: '1px' },
        _vertical: { divideY: '1px' },
      },
      item: {
        borderColor: 'border.default',
