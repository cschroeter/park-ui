...
export const DatePicker = defineMultiStyleConfig({
  baseStyle: definePartsStyle({
    ...
    tableHeader: { color: 'fg.muted', fontWeight: 'semibold', height: '10', textStyle: 'sm' },
    viewControl: { display: 'flex', gap: '2', justifyContent: 'space-between' },
    table: { width: 'full', borderCollapse: 'separate', borderSpacing: '1', m: '-1' },
