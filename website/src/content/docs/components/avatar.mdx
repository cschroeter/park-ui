...
Learn how to use the `Avatar` component in your project. Let's take a look at the most basic ComponentExample:
...
<ComponentExample name="root-provider" />

> If you're using the `RootProvider` component, you don't need to use the `Root` component.

### Next.js Image

Here's an ComponentExample of how to use the `Image` component from `next/image`.
