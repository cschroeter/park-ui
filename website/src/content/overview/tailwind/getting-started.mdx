...
foundation for most components. To install Ark UI, execute the following command in your project's root directory. For
some helper components, you'll also need to install [Zag](https://zagjs.com):

```bash multi
npm install @ark-ui/react @zag-js/react
```
...
<Step number="4" title="Add your first component">
