...
**Please note:** If you are using Next.js with React Server Components, you may want to add `'use client'` at the top of the file.

</Step>
<Step number="5" title="Path Aliases (Optional)">
