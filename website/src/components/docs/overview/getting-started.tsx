      ...
      <Steps>
        ...
        <Step number="2" title="Install Ark UI">
          <Typography color="fg.muted">
            ...
            To install Ark UI, execute the following command in your project's root directory:
          </Typography>
        ...
        <Step number="3" title="Install the Panda Presets">
          ...
          <Typography color="fg.muted">
            After you've installed the presets, you'll need to add it to your Panda configuration
            file along with your preferred <pre>jsxFramework</pre> like shown below:
          </Typography>
        ...
        <Step number="4" title="Setup Your Font Family">
          <Typography color="fg.muted">
            By default, Park UI usees Plus Jakarta Sans. However, you are free to use any font
            family that aligns with your needs, as long as it is mapped to the{' '}
            <pre>--font-body</pre> variable. The example below illustrates how to add a font family
            to the body element within the Next.js framework.
          </Typography>
